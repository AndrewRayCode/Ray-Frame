...
web build:
 - http://mootools.net/core/9ad5c0febe8977cf6db543fccf530777

packager build:
 - packager build Core/Array Core/String Core/Event Core/Browser Core/Class Core/Element.Style Core/Element.Event Core/Element.Dimensions Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Request Core/Request.JSON Core/Cookie Core/JSON Core/DOMReady
